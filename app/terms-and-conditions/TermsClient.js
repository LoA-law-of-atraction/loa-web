...
const TermsClient = () => {
  ...
  return (
    <>
      ...
      >
        <h1 className="text-h2 pt-36 pb-20 lg:text-h3 text-white w-full text-center mb-14">
          Terms & Conditions
        </h1>
        <div className="mx-auto px-5 md:px-[5%] 2xl:px-0 pb-20 container max-w-[1200px]">
          <article className="flex flex-col gap-5 text-white">
            ...
            <p className="text-base">
              Welcome to LoA (&quot;we&quot;, &quot;our&quot;, or
              &quot;us&quot;). These Terms and Conditions (&quot;Terms&quot;)
              govern your use of the LoA mobile application (&quot;App&quot;)
              and any related services we provide.
            </p>
            <p className="text-base">
              By downloading or using the App, you agree to these Terms. If you
              do not agree, please do not use LoA.
            </p>
            ...
            <p className="text-base">
              You must be at least 13 years old to use this app. By using LoA,
              you confirm that you meet this age requirement and are legally
              able to accept these Terms.
            </p>
            <h2 className="text-lg font-bold mt-6">3. Use of the App</h2>
            ...
            <ul className="list-disc list-inside text-base ml-4">
              ...
              <li>
                Not use the app in a way that interferes with its normal
            ...
            <p className="text-base">
              If LoA offers premium or paid features in the future, all
              purchases will be processed securely through Google Play Billing.
              By subscribing or purchasing, you agree to the terms provided by
              Google Play, including:
            </p>
            <ul className="list-disc list-inside text-base ml-4">
              <li>
                Automatic renewals unless canceled before the renewal date
              </li>
              <li>
                No refunds after payment, except as required by law or Google
                Play policy
              </li>
            </ul>
            <p className="text-base">
            ...
            <h2 className="text-lg font-bold mt-6">6. Intellectual Property</h2>
            <p className="text-base">
              ...
              materials from the app for commercial purposes without prior
              written consent.
            </p>
            <h2 className="text-lg font-bold mt-6">
            ...
            <p className="text-base">
              LoA is provided on an &quot;as is&quot; and &quot;as
            ...
            <ul className="list-disc list-inside text-base ml-4">
              ...
              <li>
                The suitability of LoA for your specific goals or mental
                wellness outcomes
              </li>
            </ul>
            <p className="text-base">
              LoA is a self-reflection and mindfulness tool, not a substitute
              for professional therapy, coaching, or medical advice.
            </p>
            ...
            <p className="text-base">
              To the fullest extent permitted by law, LoA and its creators are
            ...
            <h2 className="text-lg font-bold mt-6">9. Privacy</h2>
            <p className="text-base">
            ...
            <h2 className="text-lg font-bold mt-6">10. Third-Party Services</h2>
            <p className="text-base">
            ...
            <p className="text-base">
              ...
              for the device on which you&apos;re using the app, please be aware
              that we assume that you have received permission from the bill
              payer for using the app.
            </p>
            <h2 className="text-lg font-bold mt-6">11. Termination</h2>
            <p className="text-base">
            ...
            <p className="text-base">
              ...
              we&apos;ll post the updated version in the app or on our website.
              By continuing to use LoA after updates, you agree to the new
              Terms.
            </p>

            <h2 className="text-lg font-bold mt-6">13. Governing Law</h2>
            <p className="text-base">
            ...
            <h2 className="text-lg font-bold mt-6">15. Contact Us</h2>
            <p className="text-base">
